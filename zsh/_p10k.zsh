# Generated by Powerlevel10k configuration wizard on 2020-02-26 at 13:39 PST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 04858.
# Wizard options: powerline, classic, dark, angled separators, sharp heads, flat tails,
# 2 lines, solid, right frame, sparse, concise, transient_prompt.
...
# MOD: Global Config
# ZSH_OS_TYPE
# USE_NERD_FONT: if you have any special characters not showing correctly,
#   set to false to use `powerline` font
# go to https://www.nerdfonts.com/font-downloads and install patched Ubuntu Mono
...
# mod: my own host name rules
# https://en.wikipedia.org/wiki/List_of_Unicode_characters#Miscellaneous_Symbols

if [ $USE_NERD_FONT = "true" ]; then
    function myhostname() {
        if [ $ZSH_OS_TYPE = "docker" ]; then
            echo '\uf308 [%B%m]'
        elif [ $ZSH_OS_TYPE = "mac" ]; then
            echo '⛺'
        else
            _host="`hostname -s`"
            if [ "$_host" = "sc" ]; then
                echo '\uf424  %Bsc head'
            elif [ "$_host" = "macondo-ws-2" ]; then
                echo '\ue27f  %Bws2'  # atom
            else
                echo '\uf219  %B%m'  # diamond
            fi
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # on macbook, host name (home emoji) goes first
    # =========================[ Line #1 ]=========================
#     os_icon               # os identifier
  ...
  else  # on linux, host name goes last
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # os_icon               # os identifier
    dir                     # current directory
...
#     vi_mode                 # vi mode (you don't need this if you've enabled prompt_char)
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=193
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=213
...
#   typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮'
  ...
  if [ $ZSH_OS_TYPE = "mac" ]; then
      ...
      typeset -g POWERLEVEL9K_DIR_FOREGROUND=172
      # Color of the shortened directory segments.
      typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=181
...
#   )
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%B%13F'   # MOD: pink foreground
      local   modified='%172F'  # yellow foreground
      local  untracked='%244F'   # MOD: grey foreground
...
#   typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION=
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=237
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=69
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=VISUAL
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=237
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=69
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND=237
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=69
  ...
  # other color: 221 for gold. 195 blue-white-ish. 189 purple-white. 231 mostly white
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=152
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=152

  if [[ $ZSH_OS_TYPE != "mac" ]]; then
      typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=233
      typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=233
  fi
...
#   typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'
  # MOD: only show hostname
  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%m'
  # myhostname is a function defined at the very top
  # Caution: must add surrounding "" to `myhostname`
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE="`myhostname`"
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="`myhostname`"

  # Don't show context unless running with privileges or in SSH.
  # Tip: comment out the next line to always show context.
...
#   typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='⭐'
  ...
  #####################[ anaconda: conda environment (https://conda.io/) ]######################
  if [[ $ZSH_OS_TYPE = "mac" ]]; then
      typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=211  # orange-purple
  else
      typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=207  # purple
  fi
...
#   typeset -g POWERLEVEL9K_AZURE_VISUAL_IDENTIFIER_EXPANSION='az'
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%I:%M %p}'  # AM/PM time
